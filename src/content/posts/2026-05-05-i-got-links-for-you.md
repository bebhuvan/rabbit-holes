...
[All of this](https://handyai.substack.com/p/your-ceo-is-suffering-from-ai-psychosis) is just three and a half years since the launch of ChatGPT: 

> While leadership sleeps four hours a night generating 37,000 lines of bloated code, the New York Times coined a term for what’s happening downstream: “++[tokenmaxxing](https://www.nytimes.com/2026/03/20/technology/tokenmaxxing-ai-agents.html)++.” It’s a competitive status game where employees race to consume the most AI tokens. OpenAI has an engineer who processed 210 billion tokens in a single week. Anthropic has a single Claude Code user running a $150,000 monthly bill. Shopify’s Tobi Lutke made AI usage a ++[factor in performance reviews](https://www.fastcompany.com/91312832/shopify-ceo-tobi-lutke-ai-is-now-a-fundamental-expectation-for-employees)++ (Meta did the same). Some companies have literal internal leaderboards tracking who burns the most tokens.
>
...
This is from Colgate-Palmolive's [recent earnings call](https://www.google.com/finance/beta/quote/CL:NYSE?tab=earnings). If the Strait of Hormuz crisis continues, we'll start seeing serious inflationary pressures. Companies will take a hit to their margins, but beyond a point, they'll start passing on costs: 
...
[Scrapling](http://scrapling.readthedocs.io) for scraping sites.

---

**A few nice charts**

This is [amazing](https://ourworldindata.org/search?datasetProducts=Electricity+Mix)! 

![image.png](/images/image-6.png)

We'll [long be discussing](https://ourworldindata.org/grapher/ict-adoption-per-100-people?time=1990..latest&country=~IND) the impact of this.

![image.png](/images/image-7.png)

---

Arindrajit Dube on [his experiences](https://x.com/arindube/status/2053989620824600586?s=20) using Claude and CODEX in economics research:
...
>
> [https://x.com/arindube/status/2053989620824600586?s=20](https://x.com/arindube/status/2053989620824600586?s=20)

---

Can LLMs identify [new tax loopholes](https://www.theguardian.com/commentisfree/2026/may/08/how-dangerous-is-anthropics-mythos-ai) in the same way that they identify software flaws? 
...
I'm bullish [on this](https://x.com/bergerthor/status/2053808229365289185).
