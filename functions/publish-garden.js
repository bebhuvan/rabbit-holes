...
// Creates new post AND updates related posts with backlinks
...
export async function onRequest(context) {
  ...
  try {
    ...
    if (!skipBacklinks && env.AI) {
      try {
        // Fetch existing posts with content for AI analysis
    ...
    const frontmatter = {
      ...
      ...(relatedPosts.length > 0 && {
        related_posts: relatedPosts.map(slug => {
...
// Update existing posts with backlinks to the new post
